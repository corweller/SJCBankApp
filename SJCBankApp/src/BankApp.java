...
public class BankApp extends JFrame {
    ...
    // Admin creds input for Login Creds
    ...
    public BankApp() {
        ...
        // Add USERNAME and PASSWORD to login creds hashmap
    ...
    public JPanel loginScreen() {
        ...
        // Message Label to depict login failure
        ...
        loginButton.addActionListener(e -> {
            ...
            // Check for incorrect or correctly entered login credentials
            // Updated username to allow for any case entered
    ...
    public JPanel checkingScreen() {
        ...
        submitButton1.addActionListener(e -> {
            ...
            if (jCBIndex == 1) {
                ...
                // and throw error if funds are not available in account -- added/updated 07Jul22, CO
                if(newBalance < (0 - .001)) {
                    try {
    ...
    public JPanel savingsScreen(){
        ...
        submitButton2.addActionListener(e -> {
            ...
            if (jCBIndex == 1) {
                ...
                //if-else statement and code added to withdraw amount entered,
                // and throw error if funds are not available in account
                if(newBalance < (0 - .1)) {
                    try {
                        throw new NotValidAmountException("Not enough funds in account to withdraw. Please enter a valid amount.");
                    } catch (Exception ex) {
